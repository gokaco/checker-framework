...
import org.checkerframework.checker.prototype.qual.PrototypePositive;
...
public class PrototypeAnnotatedTypeFactory extends BaseAnnotatedTypeFactory {
    ...
    public PrototypeAnnotatedTypeFactory(BaseTypeChecker checker) {
        super(checker);
        addAliasedAnnotation(PrototypePositive.class, COMMON);
        postInit();
    }
    ...
    protected Set<Class<? extends Annotation>> createSupportedTypeQualifiers() {
        ...
        result.remove(PrototypePositive.class);
        return result;
    }
    ...
    private void addCommonSignedAnnotation(Tree tree, AnnotatedTypeMirror type) {
    ...
    private class PrototypeTreeAnnotator extends TreeAnnotator {
        ...
        private void annotateBooleanAsUnknownSignedness(AnnotatedTypeMirror type) {
            switch (type.getKind()) {
                case BOOLEAN:
                    type.addAnnotation(UNKNOWN_SIGNED);
                    break;
                default:
